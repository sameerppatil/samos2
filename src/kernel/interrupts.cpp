...
extern TerminalManager terminal;
...
InterruptManager::InterruptManager(uint16_t hardwareInterruptOffset, GlobalDescriptorTable* globalDescriptorTable, TerminalManager* tm)
      ...
      programmableInterruptControllerSlaveDataPort(0xA1)
{
    ...
    this->term = tm;
    this->term->writeStr("Successfully installed IDT");
}
